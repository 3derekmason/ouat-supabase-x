    ...
    <div className="flex flex-col justify-center flex-1 w-full gap-2 px-8 sm:max-w-md">
      ...
      >
        ...
        <input
          ...
          required
        />
        <button className="px-4 py-2 mb-2 rounded-md bg-warm-400 text-foreground">
          Sign In
        </button>
        <p className="text-center">or</p>
        <button
          formAction={signUp}
          className="px-4 py-2 mb-2 border rounded-md border-foreground/20 text-foreground bg-cool-400"
        >
          Sign Up
        </button>
